...
<c:if test="${empty serviceList}">
  <p>No services found (JSP).</p>
</c:if>

<c:if test="${not empty serviceList}">
  <p>Service list loaded with size: ${fn:length(serviceList)}</p>
</c:if>
<c:if test="${not empty serviceList}">
...
<c:forEach var="service" items="${serviceList}">
	  ...
	  <div class="venue-card" style="width: 250px; margin-right: 1rem; flex-shrink: 0;">
	    <div class="card-image" style="height: 200px; width: 100%;">
	      <img
	        src="${pageContext.request.contextPath}/resources/images/service/${service.imgPath}"
	        alt="Hotel"
	    ...
	    <div class="card-info" style="padding: 0.5rem;">
	      ...
	      <span class="price">${service.cost}</span><br>
