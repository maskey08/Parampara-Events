...
<body class="main-layout">
    ...
    <div class="service-detail-section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="<c:url value='/resources/images/service_img1.jpg' />" alt="${service.name}" class="service-image">
                </div>
                <div class="col-md-6 service-details">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="<c:url value='/services' />" class="btn btn-outline-secondary ml-3">Back to Services</a>
                    </div>
                </div>
            </div>
        ...
        <div class="footer">
                    ...
                    <div class="col-md-4">
                        <div class="fid_box">
                            ...
                            <ul class="location_icon">
                                <li><a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i></a><br> Mumbai, India</li>
                                <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i></a><br> +91 987 654 3210</li>
                                <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i></a><br> info@paramparaevents.com</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="copyright">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <p>© 2023 All Rights Reserved. <a href="https://paramparaevents.com/">Parampara Events</a></p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <nav class="navigation navbar navbar-expand-md navbar-dark">
                            ...
                            <div class="collapse navbar-collapse" id="navbarsExample04">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="<c:url value='/testimonial' />">Testimonial</a>
                                    </li>
                                    <li class="nav-item">
